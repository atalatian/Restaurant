...
public class Item_hamburger_supertasty_double {
    ...
    public Item_hamburger_supertasty_double(String food_text, String image_url){
    ...
    public void defineRoot() {
        ...
        gridPane.setStyle("-fx-background-color: darkgoldenrod");
